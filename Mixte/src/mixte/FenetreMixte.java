 ...
 * @author chaima
 */
public class FenetreMixte extends JFrame{
    JLabel l;
     TextField but;
     TextField but2;
     TextArea txt ;
    ...
    public FenetreMixte(){
       ...
       JLabel l01 = new JLabel("Conflit resolution : the rule having the greatest number of facts");
        ...
        JLabel titre = new JLabel("Mixte chaining");
       ...
       b.addActionListener(new ActionListener()
                ...
                Mixte m = new Mixte(chem_bf,chem_br);
                     Boolean verif=m.chainage_mixte(but.getText());
                ...
                try {
                    ...
                    Logger.getLogger(FenetreMixte.class.getName()).log(Level.SEVERE, null, ex);
                }
         ...
         b1.addActionListener(new ActionListener()
                {
                    public void actionPerformed(ActionEvent e)
                    {
                     ...
                     Boolean verif=m.chainage_mixte2(but2.getText(),BR2);
                     String trace=m.getTrace();
                    if  (verif){
